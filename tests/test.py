...
from hikari_core import callback_hikari, hikari_config, init_hikari, set_hikari_config  # noqa: E402


async def start():
    start_time = time.time()
    set_hikari_config(use_broswer='chromium', http2=False, proxy='http://localhost:7890', token='test:yuyuko_test')
    hikari_data = await init_hikari('QQ', '1023147439', '[CQ:at,qq=1023147439] recent 2')
